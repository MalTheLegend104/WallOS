...
static const pci_vendor_t pci_vendors[] = {
    ...
    {0x10de, 2301, 1966, "NVIDIA Corporation"},
    {0x10ec, 4267, 84, "Realtek Semiconductor Co., Ltd."},
    {0x1102, 4351, 18, "Creative Labs"},
    {0x1106, 4369, 378, "VIA Technologies, Inc."},
    {0x13f6, 4747, 7, "C-Media Electronics Inc"},
    {0x1458, 4754, 4, "Gigabyte Technology Co., Ltd"},
    {0x1462, 4758, 1, "Micro-Star International Co., Ltd. [MSI]"},
    {0x14e4, 4759, 362, "Broadcom Inc. and subsidiaries"},
    {0x1558, 5121, 1, "CLEVO/KAPOK Computer"},
    {0x15ad, 5122, 18, "VMware"},
    {0x168c, 5140, 38, "Qualcomm Atheros"},
    {0x17aa, 5178, 6, "Lenovo"},
    {0x1987, 5184, 16, "Phison Electronics Corporation"},
