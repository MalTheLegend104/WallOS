...
C_FLAGS 		:= -ffreestanding -std=gnu99 -O2 -g -Wall -Wextra -Wno-format -nostdlib -lgcc -msse -msse2
CPP_FLAGS 		:= -ffreestanding -fno-rtti -O2 -g -Wall -Wextra -Wno-format -nostdlib -lgcc -msse -msse2
NASM_FLAGS 		:= 
LINKER_FLAGS 	:=
