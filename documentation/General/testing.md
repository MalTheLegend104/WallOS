...
- Stage 1 (Primary)
  - QEMU
    ...
    - Realize that your Pull Requests _will_ be tested with Stage 1 and Stage 2.
- Stage 2 (Secondary)
  - Bochs
  - Virtualbox
- Stage 3 (Final)
...
This _will_ change if WallOS ever gets to the point of being self-hosted.
...
- While it _can_ be used from the command line, it's more cumbersome to set up this way than either bochs or QEMU.
...
> Above is a very old version of this doc. See [the new hardware testing doc](../Testing/testing.md).
