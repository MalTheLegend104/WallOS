...
LIBRARY_INCLUDES += $(ACPICA_INCLUDE_DIR) $(APOLLO_INCLUDE_DIR) $(FATFS_INCLUDE_DIR) $(UACPI_INCLUDE_DIR) $(KILO_INCLUDE_DIR)
LIBRARY_FLAGS	 += -Llibs/output $(ACPICA_LIB) $(APOLLO_LIB) $(FATFS_LIB) $(UACPI_LIB) $(KILO_LIB)
